...
//			Task::self()->nice(2*Task::self()->tid());
	...
	int test_scheduling() {
		...
		Task * pang = new Task(-5, function, 1, (char*)"\tPang");
		Task * peng = new Task(-4, function, 1, (char*)"\t\tPeng");
		Task * ping = new Task(-3, function, 1, (char*)"\t\t\tPing");
		Task * pong = new Task(-2, function, 1, (char*)"\t\t\t\tPong");
		Task * pung = new Task(-1, function, 1, (char*)"\t\t\t\t\tPung");
